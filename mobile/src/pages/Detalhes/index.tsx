...
const Detalhes = () => {
  ...
  useEffect(() => {
    api.get(`pontos/${routeParams.ponto_id}`).then(response => {
  ...
  function eviaWhatsapp() {
    Linking.openURL(`whatsapp://send?phone=${dados.ponto.whatsapp}&text=Tenho interesse na coleta de resíduos`);
  }
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <Image 
          ...
          source={{ uri: dados.ponto.imagem_url}} />
    ...
    <View style={styles.footer}>
      <RectButton style={styles.button} onPress={eviaWhatsapp}>
